...
/*
** The backticks after the type declaration are used for mapping
** from bson to json as well as for validation.
 */
type Genre struct {
	GenreID   int    `bson:"genre_id,omitempty" json:"genre_id,omitempty" validate:"required"`
...
type Movie struct {
	...
	//The 'dive' keyword below makes sure that the validation is applied to every element of the array.
